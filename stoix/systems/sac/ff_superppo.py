    ...
    def _update_step(
        ...
        def _update_epoch(update_state: Tuple, _: Any) -> Tuple:
            ...
            def _alpha_loss_fn(
                ...
                _,log_prob,pre_action = actor_apply_fn(actor_params, transitions.obs,key)
            ...
            def _actor_update_step(carry,_:Any):
                ...
                params, opt_states,transitions,adv = carry
                actor_grad_fn = jax.grad(_actor_loss_fn, has_aux=True)
                actor_grads, actor_loss_info = actor_grad_fn(params.actor_params, adv, transitions)
                ...
                return (new_params,new_opt_state,transitions,adv),actor_loss_info
            ...
            carry = (params,opt_states,transitions,adv)
            (params,opt_states,_,_),actor_loss_info = jax.lax.scan(_actor_update_step,carry,None,16) 
